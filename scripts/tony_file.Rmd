...
When examining the location data, there is a difference between complete data schools and missing data schools with regard to location data. Complete data schools had a higher percentage of rural schools (24% to 15% in the missing data group) as well as a higher percentage of suburban schools (18% to 17%). Alternatively, the missing data group had a higher percentage of urban schools (62% compared to 58% of Urban schools in the complete data group).
